...
public class FluxStateTracker {
    ...
    public static void LoadGameState(FluxStates gameState, bool loadTrackers) {
        ...
        mainCam.enabled = gameState.camera.enabled;
        mainCam.fieldOfView = gameState.camera.fieldOfView;
        playerCam.fieldOfView = gameState.camera.fieldOfView;

        mainCam.transform.localPosition = gameState.camera.localPosition;
        mainCam.transform.localRotation = gameState.camera.localRotation;
        mainCam.transform.position = gameState.camera.position;
        mainCam.transform.rotation = gameState.camera.rotation;

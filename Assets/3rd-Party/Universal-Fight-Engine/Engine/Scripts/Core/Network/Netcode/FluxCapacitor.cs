...
//		}
	...
	protected virtual void UpdateTimer(){
		...
		if (UFE.timer == 0 && p1ControlsScript != null && !UFE.config.lockMovements){
			Fix64 p1LifePercentage = p1ControlsScript.currentLifePoints/(Fix64)p1ControlsScript.myInfo.healthPoints;
            Fix64 p2LifePercentage = p2ControlsScript.currentLifePoints / (Fix64)p2ControlsScript.myInfo.healthPoints;
			UFE.PauseTimer();
			UFE.config.lockMovements = true;
			UFE.config.lockInputs = true;

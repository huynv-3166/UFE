...
namespace TOHDragonFight3D
{
    ...
    public class MoveInfo : ScriptableObject
    {
        ...
        public Sprite skillBorderPicture;
        public Sprite skillPicture;
        public SkillSizeType skillsizeType;
        ...
        public CharacterAttributeInfo[] moveAtrributes = new CharacterAttributeInfo[0];
        public StatusResistanceInfo[] statusResistances = new StatusResistanceInfo[0];
        public GameObject characterPrefab;
        public string moveName;
        public string description;
        public int fps = 60;
        public bool characterScaling = false;
        public bool autoAbility = false;
        ...
        public bool ContainMoveAttribute(string attributeName)
        {
            return Array.Exists(moveAtrributes, x => x.attributeName == attributeName);
        }

        public bool IsMatchCharacterAttribute(CharacterInfo characterInfo)
        {
            return Array.Exists(characterInfo.characterAtrributes,
                characterAtrribute =>
                (Array.Exists(moveAtrributes,
                moveAtrribute =>
                moveAtrribute.attributeName == characterAtrribute.attributeName)));
        }

        [ContextMenu("CopyGaugesFromClipboard")]
        public void CopyGaugesFromClipboard()
        {
            this.gauges = UFE.currentEditorConfig.basicgauges;
        }

        [ContextMenu("CopySoundsToClipboard")]
        public void CopySoundsToClipboard()
        {
            UFE.currentEditorConfig.soundEffects = this.soundEffects;
        }

        [ContextMenu("CopySoundsFromClipboard")]
        public void CopySoundsFromClipboard()
        {
            this.soundEffects = UFE.currentEditorConfig.soundEffects;
        }
    }
}
...
public class MoveAttributeEditorWindow : EditorWindow
{
    public static MoveAttributeEditorWindow moveattributeEditorWindow;
    public static TOHDragonFight3D.MoveAttributeInfo sentAttributeInfo;
    private TOHDragonFight3D.MoveAttributeInfo attributeInfo;
    ...
    [MenuItem("Window/U.F.E./Move Attribute Editor")]
    public static void Init()
    {
        moveattributeEditorWindow = EditorWindow.GetWindow<MoveAttributeEditorWindow>(false, "Move Attribute", true);
        moveattributeEditorWindow.Show();
        moveattributeEditorWindow.Populate();
    }
    ...
    void Populate()
    {
        this.titleContent = new GUIContent("Move Attribute", (Texture)Resources.Load("Icons/Square"));
        ...
        UnityEngine.Object[] selection = Selection.GetFiltered(typeof(TOHDragonFight3D.MoveAttributeInfo), SelectionMode.Assets);
        if (selection.Length > 0)
        {
            if (selection[0] == null) return;
            attributeInfo = (TOHDragonFight3D.MoveAttributeInfo)selection[0];
        }
    }
    ...
    public void OnGUI()
    {
        if (attributeInfo == null)
        {
            ...
            GUILayout.Label("Select a attribute move file\nor create a new move attribute.", "CN EntryInfo");
            GUILayout.EndHorizontal();
            EditorGUILayout.Space();
            if (GUILayout.Button("Create new move attribute"))
                ScriptableObjectUtility.CreateAsset<TOHDragonFight3D.MoveAttributeInfo>();
            return;
        }

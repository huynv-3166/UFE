...
namespace TOHDragonFight3D
{
    public class BattleGUI : UFEScreen
    {
        ...
        [SerializeField] protected PlayerInfo player1 = new PlayerInfo();
        [SerializeField] protected PlayerInfo player2 = new PlayerInfo();
        ...
        protected virtual void OnGameBegin(ControlsScript player1, ControlsScript player2, StageOptions stage)
        {
            ...
            this.player1.targetLife = player1.myInfo.healthPoints;
            this.player1.totalLife = player1.myInfo.healthPoints;
            this.player1.wonRounds = 0;

            this.player2.controlsScript = player2;
            this.player2.targetLife = player2.myInfo.healthPoints;
            this.player2.totalLife = player2.myInfo.healthPoints;
        ...
        protected virtual void OnParticleEffects(MoveInfo move, ControlsScript player, AbstractParticleEffect particleEffects)
        {
        ...
        protected virtual void FillInAttributes(CharacterInfo characterInfo, Image[] attributeImages)
        {
            
        }

        protected virtual void FillInRareness(int rareness, Image[] rareImages)
        {
            
        }

        protected virtual void RefreshSkillButtons()
        {

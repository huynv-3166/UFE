...
public class UFE : MonoBehaviour, UFEInterface
{
    ...
    public delegate void ParticleEffectsHandler(MoveInfo move, ControlsScript player, AbstractParticleEffect particleEffects);
    ...
    public delegate void StoryModeHandler(TOHDragonFight3D.CharacterInfo character);
    ...
    public static GlobalInfo currentEditorConfig;
    ...
    public static void SetFuzzyAI(int player, TOHDragonFight3D.CharacterInfo character)
    {
        UFE.SetFuzzyAI(player, character, UFE.config.aiOptions.selectedDifficulty);
    }

    public static void SetFuzzyAI(int player, TOHDragonFight3D.CharacterInfo character, AIDifficultySettings difficulty)
    {
    ...
    public static CharacterStory GetCharacterStory(TOHDragonFight3D.CharacterInfo character)
    {
        if (!UFE.config.storyMode.useSameStoryForAllCharacters)
        {
            StoryMode storyMode = UFE.config.storyMode;

            for (int i = 0; i < UFE.config.skins.Length; ++i)
            {
                if (UFE.config.skins[i].characters[0] == character && storyMode.selectableCharactersInStoryMode.Contains(i))
                {
    ...
    public static void SetAI(int player, TOHDragonFight3D.CharacterInfo character)
    {
        if (UFE.isAiAddonInstalled)
        {
            UFEController controller = UFE.GetController(player);
    ...
    public static TOHDragonFight3D.CharacterInfo GetPlayer(int player)
    {
        if (player == 1)
        {
    ...
    public static TOHDragonFight3D.CharacterInfo GetPlayer1()
    {
        return config.player1Character;
    }

    public static TOHDragonFight3D.CharacterInfo GetPlayer2()
    {
        return config.player2Character;
    }

    public static TOHDragonFight3D.CharacterInfo[] GetStoryModeSelectableCharacters()
    {
        List<TOHDragonFight3D.CharacterInfo> characters = new List<TOHDragonFight3D.CharacterInfo>();

        for (int i = 0; i < UFE.config.skins.Length; ++i)
        {
            if (
                UFE.config.skins[i] != null
                &&
                (
                    UFE.config.storyMode.selectableCharactersInStoryMode.Contains(i) ||
                    UFE.unlockedCharactersInStoryMode.Contains(UFE.config.skins[i].characters[0].characterName)
                )
            )
            {
                characters.Add(UFE.config.skins[i].characters[0]);
            }
        }
    ...
    public static TOHDragonFight3D.CharacterInfo[] GetTrainingRoomSelectableCharacters()
    {
        List<TOHDragonFight3D.CharacterInfo> characters = new List<TOHDragonFight3D.CharacterInfo>();
        ...
        for (int i = 0; i < UFE.config.skins.Length; ++i)
        {
            ...
            if (
                ...
                (
                    ...
                    UFE.unlockedCharactersInStoryMode.Contains(UFE.config.skins[i].characters[0].characterName) ||
                    UFE.unlockedCharactersInVersusMode.Contains(UFE.config.skins[i].characters[0].characterName)
                )
            )
            {
                characters.Add(UFE.config.skins[i].characters[0]);
    ...
    public static TOHDragonFight3D.CharacterInfo[] GetVersusModeSelectableCharacters()
    {
        List<TOHDragonFight3D.CharacterInfo> characters = new List<TOHDragonFight3D.CharacterInfo>();
    ...
    public static void SetPlayer(int player, TOHDragonFight3D.CharacterInfo info)
    {
        if (player == 1)
        {
    ...
    public static void SetTeamCharacter(int player, int position, TOHDragonFight3D.CharacterInfo info)
    {
        if (player == 1)
        {
    ...
    public static TOHDragonFight3D.CharacterInfo GetTeamCharacter(int player, int position)
    {
        if (player == 1)
        {
    ...
    public static void SetPlayer1(TOHDragonFight3D.CharacterInfo player1)
    {
        config.player1Character = player1;
    }

    public static void SetPlayer2(TOHDragonFight3D.CharacterInfo player2)
    {
    ...
    public static void RemoveUnlockedCharacterInStoryMode(TOHDragonFight3D.CharacterInfo character)
    {
    ...
    public static void RemoveUnlockedCharacterInVersusMode(TOHDragonFight3D.CharacterInfo character)
    {
        if (character != null && !string.IsNullOrEmpty(character.characterName))
        {
    ...
    public static void UnlockCharacterInStoryMode(TOHDragonFight3D.CharacterInfo character)
    {
        if (
            character != null &&
    ...
    public static void UnlockCharacterInVersusMode(TOHDragonFight3D.CharacterInfo character)
    {
        if (
            character != null &&
            !string.IsNullOrEmpty(character.characterName) &&
    ...
    public static void FireParticleEffects(MoveInfo move, ControlsScript player, AbstractParticleEffect particleEffects)
    {
    ...
    protected void Start()
    {
        ...
        if (UFE.config.deploymentOptions.deploymentType != DeploymentType.FullInterface)
        {
            ...
            else
            {
                ...
                UFE.config.player1Team = new TOHDragonFight3D.CharacterInfo[maxSizePlayer1];
                UFE.config.player2Team = new TOHDragonFight3D.CharacterInfo[maxSizePlayer2];
    ...
    public static void _StartStoryModeBattle(float fadeTime)
    {
        ...
        TOHDragonFight3D.CharacterInfo character = UFE.GetPlayer(1);
        ...
        if (UFE.player1WonLastBattle)
        {
            ...
            )
            {
                ...
                if (currentGroup.mode == FightsGroupMode.FightAgainstAllOpponentsInTheGroupInTheDefinedOrder)
                {
                    ...
                    TOHDragonFight3D.CharacterInfo opponent = UFE.config.skins[b.opponentCharacterIndex].characters[0];
        ...
        if (UFE.storyMode.currentBattleInformation != null)
        {
            ...
            int skinIndex = UFE.storyMode.currentBattleInformation.opponentCharacterIndex;
            UFE.SetPlayer2(UFE.config.skins[skinIndex].characters[0]);
    ...
    private static void _StartGame(float fadeTime)
    {
        ...
        if (UFE.config.selectedMatchType != MatchType.Singles)
        {
            ...
            int counter = 0;
            foreach (TOHDragonFight3D.CharacterInfo character in UFE.config.player1Team)
            {
            ...
            counter = 0;
            foreach (TOHDragonFight3D.CharacterInfo character in UFE.config.player2Team)
            {
        ...
        if (cScript1 != null && cScript2 != null)
        {
            ...
            for (int i = 1; i <= 2; i++)
            {
                ...
                TOHDragonFight3D.CharacterInfo opCharInfo;
                if (i == 1)
                {
                    opCScript = cScript2;
    ...
    public static ControlsScript SpawnCharacter(TOHDragonFight3D.CharacterInfo characterInfo, int player, int mirror, FPVector location, bool isAssist, MoveInfo enterMove = null, MoveInfo exitMove = null, int altCostume = -1)
    {
        ...
        if (isNew)
        {
            ...
            cScript.Natures = cScript.character.GetComponent<NatureScript>();
        ...
        {
            cScript.currentLifePoints = (Fix64)characterInfo.healthPoints * ((player == 1 ? UFE.config.trainingModeOptions.p1StartingLife : UFE.config.trainingModeOptions.p2StartingLife) / 100);
            for (int i = 0; i < cScript.currentGaugesPoints.Length; i++)
            {
                cScript.currentGaugesPoints[i] = (Fix64)characterInfo.maxEPS * ((player == 1 ? UFE.config.trainingModeOptions.p1StartingGauge : UFE.config.trainingModeOptions.p2StartingGauge) / 100);
            }
        }
        else
        {
            cScript.currentLifePoints = characterInfo.healthPoints;
        }
    ...
    public static ControlsScript FindSpawnedAssist(ControlsScript owner, TOHDragonFight3D.CharacterInfo characterInfo)
    {
    ...
    public static void SearchAndCastGameObject(TOHDragonFight3D.CharacterInfo characterInfo, float warmTimer)
    {
        List<MoveSetData> loadedMoveSets = new List<MoveSetData>();
        ...
        foreach (MoveSetData moveSet in loadedMoveSets)
        {
            foreach (MoveInfo move in moveSet.attackMoves)
            {
                foreach (AbstractParticleEffect particle in move.particleEffects) SearchAndCastGameObject(particle, warmTimer);
    ...
    public static float CheckAttribute(ControlsScript cScript1, ControlsScript opControlsScript)
    {
        float currentAE = 0; // Attribute Effectiveness
        foreach (CharacterAttributeInfo myAttribute in cScript1.myInfo.characterAtrributes)
        {
            foreach (CharacterAttributeInfo opAttribute in opControlsScript.myInfo.characterAtrributes)
            {
                Effectiveness effect = Array.Find(myAttribute.effectLinks,
                    foundEffect => foundEffect.targetAttribute != null &&
                    foundEffect.targetAttribute == opAttribute);

                if (effect != null)
                    currentAE += effect.effectiveness;
            }
        }
        return currentAE;
    }

    public static float CheckStab(MoveInfo move, ControlsScript cScript1)
    {
        try
        {
            float currentStab = 0;
            var intersects = cScript1.myInfo.characterAtrributes.Intersect(move.moveAtrributes);
            foreach (var element in intersects) currentStab += element.stab;
            return currentStab;
        }
        catch { return 0; }
    }
    ...
    #region Editor Inspector Method

    [ContextMenu("OneThird")]
    public void ReducePlayer1ToOneThird()
    {
        var player1 = GetControlsScript(1);
        Fix64 damage = player1.myInfo.healthPoints * 2 / 3 + 1;
        player1.DamageMe(damage, true);
    }
